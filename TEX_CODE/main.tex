...
\titleformat*{\section}{\bf\fangsong\large}
\titleformat*{\subsection}{\bf\fangsong\large}
\titleformat*{\subsubsection}{\fangsong\normalsize}
...
\renewcommand\abstractname{ \vspace{-1cm}}%摘要
...
\begin{enumerate}
\item {\fangsong 输入变压器} 
这是输入变压器. %想用subsubsubsection的自己找解决方案去吧，我懒得写了-lh
\end{enumerate}
...
